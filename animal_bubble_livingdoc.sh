...
~/.dotnet/tools/livingdoc \
  ...
  -t CattleInformationSystem.Animals/src/CattleInformationSystem.Animals.Specs/bin/Debug/net7.0/TestExecution.json \
  --binding-assemblies CattleInformationSystem.Animals/src/CattleInformationSystem.Animals.Specs/bin/Debug/net7.0/CattleInformationSystem.Animals.Specs.dll \
